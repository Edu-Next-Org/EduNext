...
//   return data;
// };
export interface ILevelsResponse { success: boolean; data: ILevelsData[]; }
export interface ILevelsData { _id: string; name: string; description: string; createdAt: string; updatedAt: string; __v: number; }

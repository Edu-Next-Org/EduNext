...
interface UpdateUserFormProps {
  isOpen: boolean;
  formik: FormikProps<UpdateUserFormValues>;
  imagePreview: string | null;
  isSaving: boolean;
  onClose: () => void;
  onFileChange: (file: File | null) => void;
  parseBirthdayValue: (value: string) => Date | null;
  formatBirthdayValue: (date: Date) => string;
}
      ...
      <div className="flex-1 overflow-y-auto px-8 py-8">
        ...
        >
          ...
          <motion.div variants={sectionVariants} className="space-y-6">
                ...
                <Popover>
                  ...
                  >
                    <Calendar
                      ...
                      locale={enUS}
                      selected={
                        parseBirthdayValue(formik.values.birthday) ?? undefined
                      }
                      onSelect={(date) => {
            ...
            <div className="space-y-2.5">
              <Label className="text-slate-700 dark:text-[#eee]">Gender</Label>
              <Select
